static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SPRINGLEAF_TOWN - 1] = {MAP_GROUP(SPRINGLEAF_TOWN), MAP_NUM(SPRINGLEAF_TOWN), 38, 10},
    [HEAL_LOCATION_CEDAR_CROSSING - 1] = {MAP_GROUP(CEDAR_CROSSING), MAP_NUM(CEDAR_CROSSING), 19, 16},
};
